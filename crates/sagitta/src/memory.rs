...
impl MemoryStore {
  ...
  fn create_strings_fixture(&self) {
    ...
    self
      .put_sync(DataPath::from(vec!["test", "strings"]), schema, vec![batch])
  ...
  fn create_empty_fixture(&self) {
    ...
    self
      .put_sync(DataPath::from(vec!["test", "empty"]), schema, vec![batch])
  ...
  fn create_large_fixture(&self) {
    ...
    self
      .put_sync(DataPath::from(vec!["test", "large"]), schema, vec![batch])
  ...
  fn create_nested_fixture(&self) {
    ...
    self
      .put_sync(DataPath::from(vec!["test", "nested"]), schema, vec![batch])
...
impl Store for MemoryStore {
  ...
  async fn put(&self, path: DataPath, schema: SchemaRef, batches: Vec<RecordBatch>) -> Result<()> {
