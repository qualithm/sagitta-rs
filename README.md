...
[![CI](https://github.com/qualithm/sagitta-rs/actions/workflows/ci.yaml/badge.svg?event=pull_request)](https://github.com/qualithm/sagitta-rs/actions/workflows/ci.yaml)
